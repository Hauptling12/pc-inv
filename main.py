...
# styling
style = ttk.Style()
# window.configure(highlightbackground = "red", highlightcolor= "red")
...
style.configure("Treeview",
                background="#1c1c1c",foreground="#ffffff",fieldbackground="#1c1c1c")
style.configure("TFrame",
                background="#1c1c1c")
style.configure("TPanedwindow",
                background="#1c1c1c")
style.configure("Treeview.Heading",background="#1c1c1c", foreground="#ffffff")
...
tbutton3.configure(background="#1c1c1c",foreground="#ffffff")
...
def editWin():
    ...
    ryle=ttk.Style()
    ryle.configure('TLabel',background="black")
    ...
    if edin == "switch":
        ...
        modell.grid(row=0,column=2)
        standards=tk.Label(add_frame,text="standards")
        standards.grid(row=0,column=3)
        net_type=tk.Label(add_frame,text="net type")
        net_type.grid(row=0,column=4)
        ports=tk.Label(add_frame,text="ports")
        ports.grid(row=0,column=5)
        fibre=tk.Label(add_frame,text="fibre")
        fibre.grid(row=0,column=6)
        port_speed=tk.Label(add_frame,text="port_speed")
        port_speed.grid(row=0,column=7)

        namel_box=tk.Entry(add_frame)
        namel_box.grid(row=1,column=0)
        brandl_box=tk.Entry(add_frame)
        brandl_box.grid(row=1,column=1)
        modell_box=tk.Entry(add_frame)
        modell_box.grid(row=1,column=2)
        standards_box=tk.Entry(add_frame)
        standards_box.grid(row=1,column=3)
        net_type_box=tk.Entry(add_frame)
        net_type_box.grid(row=1,column=4)
        ports_box=tk.Entry(add_frame)
        ports_box.grid(row=1,column=5)
        fibre_box=tk.Entry(add_frame)
        fibre_box.grid(row=1,column=6)
        port_speed_box=tk.Entry(add_frame)
        port_speed_box.grid(row=1,column=7)

        namel_box.insert(0,values[1])
        brandl_box.insert(0,values[2])
        modell_box.insert(0,values[3])
        standards_box.insert(0,values[4])
        net_type_box.insert(0,values[5])
        ports_box.insert(0,values[6])
        fibre_box.insert(0,values[7])
        port_speed_box.insert(0,values[8])
    if edin == "laptop":
        brandl=tk.Label(add_frame,text="brand")
...
tbutton2.configure(background="#1c1c1c",foreground="#ffffff")
...
def openNewWindow():
    ...
    tyle= ttk.Style(newWindow)
    tyle.configure("TLabel",background="#1c1c1c")
    # sets the title of the
    # Toplevel widget
    newWindow.title("New Window")

    newWindow.geometry("200x200")
    newWindow.configure(background="#1c1c1c")
    ...
    # convert back to json.
     ...
     # convert back to json.
       ...
       main.add(left_pane)
       main.add(right_pane)
       left = tk.Label(top,text="storage")
       left.pack()
       ...
       main.add(left_pane)
       main.add(right_pane)
       left = tk.Label(top,text="cpu_cooler")
       left.pack()
       ...
       main.add(left_pane)
       main.add(right_pane)
       left = tk.Label(top,text="motherboard")
       left.pack()
       ...
       yeare.pack(fill = tk.BOTH, expand = True)
         ...
         main.add(left_pane)
         main.add(right_pane)
         left = tk.Label(top,text="monitors")
         left.pack()
         ...
         main.add(left_pane)
         main.add(right_pane)
         left = tk.Label(top,text="adapters")
         left.pack()
     ...
     # convert back to json.
         ...
         def submit():
             ...
             l["name"]=namev.get()
             l["model"]=modelv.get()
             l["wan_port"]=wan_portv.get()
             l["lan_ports"]=lan_portsv.get()
             l["freq_band"]=freq_bandv.get()
             l["wan_standard"]=wan_standardv.get()
             l["standards"]=standardsv.get()
             l["wpa"]=wpav.get()
             def write_json(new_data, filename=jsof):
                 with open(filename,'r+') as file:
                      file_data = json.load(file)
     # Join new_data with file_data inside emp_details
                      file_data["wpa"].append(new_data)
     # Sets file's current position at offset.
                      file.seek(0)
     # convert back to json.
                      json.dump(file_data, file)
         ...
         model=tk.Label(left_pane,text="model")
         model.pack(fill=tk.BOTH,expand=True)
         wan_port=tk.Label(left_pane,text="wan_port")
         wan_port.pack(fill=tk.BOTH,expand=True)
         lan_ports=tk.Label(left_pane,text="lan_ports")
         lan_ports.pack(fill=tk.BOTH,expand=True)
         freq_band=tk.Label(left_pane,text="freq_band")
         freq_band.pack(fill=tk.BOTH,expand=True)
         wan_standard=tk.Label(left_pane,text="wan standard")
         wan_standard.pack(fill=tk.BOTH,expand=True)
         standards=tk.Label(left_pane,text="standards")
         standards.pack(fill=tk.BOTH,expand=True)
         wpa=tk.Label(left_pane,text="wpa")
         wpa.pack(fill=tk.BOTH,expand=True)

         brandv=tk.StringVar()
         namev=tk.StringVar()
         modelv=tk.StringVar()
         wan_portv=tk.StringVar()
         lan_portsv=tk.StringVar()
         freq_bandv=tk.StringVar()
         wan_standardv=tk.StringVar()
         standardsv=tk.StringVar()
         wpav=tk.StringVar()
         ...
         modele=tk.Entry(right_pane,textvariable=modelv)
         modele.pack(fill=tk.BOTH,expand=True)
         wan_porte=tk.Entry(right_pane,textvariable=wan_portv)
         wan_porte.pack(fill=tk.BOTH,expand=True)
         lan_portse=tk.Entry(right_pane,textvariable=lan_portsv)
         lan_portse.pack(fill=tk.BOTH,expand=True)
         freq_bande=tk.Entry(right_pane,textvariable=freq_bandv)
         freq_bande.pack(fill=tk.BOTH,expand=True)
         wan_standarde=tk.Entry(right_pane,textvariable=wan_standardv)
         wan_standarde.pack(fill=tk.BOTH,expand=True)
         standardse=tk.Entry(right_pane,textvariable=standardsv)
         standardse.pack(fill=tk.BOTH,expand=True)
         wpae=tk.Entry(right_pane,textvariable=wpav)
         wpae.pack(fill=tk.BOTH,expand=True)
    elif edin == "network_card":
         top = tk.Frame(newWindow, background="black", height=40)
         main = tk.PanedWindow(newWindow, background="black")
         top.pack(side="top", fill="x")
         main.pack(side="top", fill="both", expand=True)
         ...
         main.add(left_pane)
         main.add(right_pane)
         left = tk.Label(top,text="network_card")
         left.pack()
         def submit():
             l={}
             l["name"]=namev.get()
             l["brand"]=brandv.get()
             l["model"]=modelv.get()
             l["ports"]=wan_portv.get()
             l["port_speed"]=lan_portsv.get()
             l["pcie"]=freq_bandv.get()
             l["freq_band"]=wan_standardv.get()
             l["atenna"]=standardv.get()
             l["wpa"]=wpav.get()
             l["bluetooth"]=bluev.get()

             def write_json(new_data, filename=jsof):
                 with open(filename,'r+') as file:
                      file_data = json.load(file)
     # Join new_data with file_data inside emp_details
                      file_data["network_card"].append(new_data)
     # Sets file's current position at offset.
                      file.seek(0)
     # convert back to json.
                      json.dump(file_data, file)
         ...
         model=tk.Label(left_pane,text="model")
         model.pack(fill=tk.BOTH,expand=True)
         wan_port=tk.Label(left_pane,text="ports")
         wan_port.pack(fill=tk.BOTH,expand=True)
         lan_ports=tk.Label(left_pane,text="port_speed")
         lan_ports.pack(fill=tk.BOTH,expand=True)
         freq_band=tk.Label(left_pane,text="pcie")
         freq_band.pack(fill=tk.BOTH,expand=True)
         wan_standard=tk.Label(left_pane,text="freq_band")
         wan_standard.pack(fill=tk.BOTH,expand=True)
         standard=tk.Label(left_pane,text="atenna")
         standard.pack(fill=tk.BOTH,expand=True)
         wpa=tk.Label(left_pane,text="wpa")
         wpa.pack(fill=tk.BOTH,expand=True)
         blue=tk.Label(left_pane,text="bluetooth")
         blue.pack(fill=tk.BOTH,expand=True)
         ...
         wan_standarde=tk.Entry(right_pane,textvariable=wan_standardv)
         wan_standarde.pack(fill=tk.BOTH,expand=True)
         standarde=tk.Entry(right_pane,textvariable=standardv)
         standarde.pack(fill=tk.BOTH,expand=True)
         wpae=tk.Entry(right_pane,textvariable=wpav)
         wpae.pack(fill=tk.BOTH,expand=True)
         bluee=tk.Entry(right_pane,textvariable=bluev)
         bluee.pack(fill=tk.BOTH,expand=True)
    elif edin == "patchpanel":
         top = tk.Frame(newWindow, background="black", height=40)
         main = tk.PanedWindow(newWindow, background="black")
         top.pack(side="top", fill="x")
         main.pack(side="top", fill="both", expand=True)
         ...
         main.add(left_pane)
         main.add(right_pane)
         left = tk.Label(top,text="patchpanel")
         left.pack()
         def submit():
             l={}
             l["name"]=namev.get()
             ...
             l["model"]=modelv.get()
             l["ports"]=portsv.get()
             l["port_speed"]=port_speedv.get()
             def write_json(new_data, filename=jsof):
                 with open(filename,'r+') as file:
                      file_data = json.load(file)
     # Join new_data with file_data inside emp_details
                      file_data["patchpanel"].append(new_data)
     # Sets file's current position at offset.
                      file.seek(0)
     # convert back to json.
                      json.dump(file_data, file)
         ...
         ports=tk.Label(left_pane,text="ports")
         ports.pack(fill=tk.BOTH,expand=True)
         port_speed=tk.Label(left_pane,text="port_speed")
         port_speed.pack(fill=tk.BOTH,expand=True)
         ...
         portse=tk.Entry(right_pane,textvariable=portsv)
         portse.pack(fill=tk.BOTH,expand=True)
         port_speede=tk.Entry(right_pane,textvariable=port_speedv)
         port_speede.pack(fill=tk.BOTH,expand=True)
    elif edin == "switch":
         top = tk.Frame(newWindow, background="black", height=40)
         main = tk.PanedWindow(newWindow, background="black")
         top.pack(side="top", fill="x")
         ...
         def submit():
             ...
             def write_json(new_data, filename=jsof):
                 with open(filename,'r+') as file:
                      file_data = json.load(file)
     # Join new_data with file_data inside emp_details
                      file_data["switch"].append(new_data)
     # Sets file's current position at offset.
                      file.seek(0)
     # convert back to json.
                      json.dump(file_data, file)
         ...
         standards=tk.Label(left_pane,text="standards")
         standards.pack(fill = tk.BOTH, expand = True)
         net_type=tk.Label(left_pane,text="net_type")
         net_type.pack(fill = tk.BOTH, expand = True)
         ports=tk.Label(left_pane,text="ports")
         ports.pack(fill = tk.BOTH, expand = True)
         fibre=tk.Label(left_pane,text="fibre")
         ...
         standardse=tk.Entry(right_pane,textvariable=standardsv)
         standardse.pack(fill=tk.BOTH,expand=True)
         net_typee=tk.Entry(right_pane,textvariable=net_typev)
         net_typee.pack(fill=tk.BOTH,expand=True)
         portse=tk.Entry(right_pane,textvariable=portsv)
         portse.pack(fill=tk.BOTH,expand=True)
...
tbutton1.configure(background="#1c1c1c",foreground="#ffffff")
...
# networking
listtree.insert('item5','end','switch',text="switch")
listtree.insert('item5','end','wpa',text="router")
listtree.insert('item5','end','patchpanel',text="patchpanel")
listtree.insert('item5','end','network_card',text="network_card")
# level 2 parts
...
def go(event):
    ...
    if do == "network_card":
        ...
        data = json.load(f)
        edin="network_card"
        treeview=ttk.Treeview(right_pane,style="Custom.Treeview",xscrollcommand=h.set,columns=("name","brand","model","ports","port_speed","pcie","freq_band","atenna","wpa","bluetooth"))
        treeview.heading("#1",text="name")
        treeview.heading("#2",text="brand")
        treeview.heading("#3",text="model")
        treeview.heading("#4",text="ports")
        treeview.heading("#5",text="port_speed")
        treeview.heading("#6",text="pcie")
        treeview.heading("#7",text="freq_band")
        treeview.heading("#8",text="atenna")
        treeview.heading("#9",text="wpa")
        treeview.heading("#10",text="bluetooth")
        h.pack(side=tk.BOTTOM, fill='x')
        h.config(command=treeview.xview)
        treeview.pack(fill="both", expand=True)
        f.close()
        for row in data["network_card"]:
            treeview.insert("","end",values=(row["name"],row["brand"],row["model"],row["ports"],row["port_speed"],row["pcie"],row["freq_band"],row["atenna"],row["wpa"],row["bluetooth"]))
    if do == "patchpanel":
        hidse()
        f = open(jsof)
        data = json.load(f)
        edin="patchpanel"
        treeview=ttk.Treeview(right_pane,style="Custom.Treeview",xscrollcommand=h.set,columns=("name","brand","model","ports","port_speed"))
        treeview.heading("#1",text="name")
        treeview.heading("#2",text="brand")
        treeview.heading("#3",text="model")
        treeview.heading("#4",text="ports")
        ...
        treeview.pack(fill="both", expand=True)
        f.close()
        for row in data["patchpanel"]:
            treeview.insert("","end",values=(row["name"],row["brand"],row["model"],row["ports"],row["port_speed"]))
    if do == "router":
        hidse()
        f = open(jsof)
        data = json.load(f)
        edin="router"
        treeview=ttk.Treeview(right_pane,style="Custom.Treeview",xscrollcommand=h.set,columns=("brand","name","model","wan_port","lan_ports","freq_band","wan_standard","standards","wpa"))
        treeview.heading("#1",text="brand")
        treeview.heading("#2",text="name")
        treeview.heading("#3",text="model")
        treeview.heading("#4",text="wan_port")
        treeview.heading("#5",text="lan_ports")
        treeview.heading("#6",text="freq_band")
        treeview.heading("#7",text="wan_standard")
        treeview.heading("#8",text="standards")
        treeview.heading("#9",text="wpa")
        h.pack(side=tk.BOTTOM, fill='x')
        h.config(command=treeview.xview)
        treeview.pack(fill="both", expand=True)
        f.close()
        for row in data["wpa"]:
            treeview.insert("","end",values=(row["brand"],row["name"],row["model"],row["wan_port"],row["lan_ports"],row["freq_band"],row["wan_standard"],row["standards"],row["wpa"]))
    if do == "switch":
        hidse()
        f = open(jsof)
        data = json.load(f)
        edin="switch"
        treeview=ttk.Treeview(right_pane,style="Custom.Treeview",xscrollcommand=h.set,columns=("name","brand","model","standards","net_type","ports","fibre","port_speed"))
        treeview.heading("#1",text="name")
        treeview.heading("#2",text="brand")
        treeview.heading("#3",text="model")
        treeview.heading("#4",text="standards")
        treeview.heading("#5",text="net_type")
        treeview.heading("#6",text="ports")
        treeview.heading("#7",text="fibre")
        treeview.heading("#8",text="port_speed")
        h.pack(side=tk.BOTTOM, fill='x')
        h.config(command=treeview.xview)
        treeview.pack(fill="both", expand=True)
        f.close()
        for row in data["switch"]:
            treeview.insert("","end",values=(row["name"],row["brand"],row["model"],row["standards"],row["net_type"],row["ports"],row["fibre"],row["port_speed"]))
    if do == "gpu":
        hidse()
        f = open(jsof)
        data = json.load(f)
        edin="gpu"
        treeview=ttk.Treeview(right_pane,style="Custom.Treeview",xscrollcommand=h.set,columns=("name","size","core_clock","brand","model","mem_type","output","base_brand","cuda","mem_clock","card_bus","hieght","width","length","power","watt"))
    ...
    if do == "case":
        ...
        data = json.load(f)
        edin="case"
        treeview=ttk.Treeview(right_pane,style="Custom.Treeview",xscrollcommand=h.set,columns=("name","model","mobo_supp","case_type","3drive_bays","2drive_bays","pcie","ports","gpu-l","gpu-h","brand","cpu-h","window","series","fan","psu-l"))
    ...
    if do == "books":
        ...
        f = open(jsof)
        data = json.load(f)
        treeview=ttk.Treeview(right_pane,style="Custom.Treeview",columns=("name","author","date","online"))
